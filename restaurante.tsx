...
export  function Restaurante() {
  ...
  async function gerarRestaurante() {
    ...
    const prompt = `Sugira um restaurante para o ${ocasiao} usando os seguintes requisitos: ${ingr1}, ${ingr2}, ${ingr3} e ${ingr4} e pesquise o restaurante no google. Caso encontre, informe o link.`;
  ...
  return (
    <View style={ESTILOS.container}>
      ...
      <Text style={ESTILOS.header}>Restaurante para comer</Text>
      ...
      <TouchableOpacity style={ESTILOS.button} onPress={gerarRestaurante}>
